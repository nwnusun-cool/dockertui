...
// ContainerEditView 容器配置编辑视图
type ContainerEditView struct {
	// 容器信息
...
// NewContainerEditView 创建容器编辑视图
func NewContainerEditView() *ContainerEditView {
	// CPU 份额输入框
...
// Show 显示编辑视图
func (v *ContainerEditView) Show(container *docker.Container, details *docker.ContainerDetails) {
	v.visible = true
...
// IsVisible 是否可见
func (v *ContainerEditView) IsVisible() bool {
	return v.visible
}

// GetConfig 获取编辑后的配置
func (v *ContainerEditView) GetConfig() docker.ContainerUpdateConfig {
...
func (v *ContainerEditView) GetContainerID() string {
	return v.containerID
}

// GetContainerName 获取容器名称
func (v *ContainerEditView) GetContainerName() string {
	if v.container != nil {
...
// SetWidth 设置宽度
func (v *ContainerEditView) SetWidth(width int) {
	v.width = width
}

// Update 处理输入
// 返回值: (confirmed bool, handled bool, cmd tea.Cmd)
func (v *ContainerEditView) Update(msg tea.Msg) (bool, bool, tea.Cmd) {
	if !v.visible {
...
// nextFocus 切换到下一个焦点
func (v *ContainerEditView) nextFocus() {
...
// prevFocus 切换到上一个焦点
func (v *ContainerEditView) prevFocus() {
	// 如果不是 on-failure，跳过最大重试次数
...
func (v *ContainerEditView) updateInputFocus() {
	v.cpuSharesInput.Blur()
	v.memoryInput.Blur()
	v.maxRetriesInput.Blur()
...
// View 渲染编辑视图
func (v *ContainerEditView) View() string {
	if !v.visible {
		return ""
	}
